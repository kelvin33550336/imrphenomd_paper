...
ax[0].hist(np.log10(data2[:,5]), bins=bins, label="top-left optimized", histtype="step", color="C1", linewidth=3)
...
ax[1].hist(np.log10(data4[:,5]), bins=bins, label="bottom-right optimized", histtype="step", color="C1", linewidth=3)
