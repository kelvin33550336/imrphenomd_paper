...
\begin{figure}[t]
	...
	dots represent the waveforms used for validation.}
...
\kl{The improvement above the diagonal is also significant comparing with the original waveform model. However, the improvement are not as profound as optimizing all waveform at once. This shows that the ansatz can achieve a better fit using training waveforms with similar spins, even for waveforms with non-equal spin parameters. }
