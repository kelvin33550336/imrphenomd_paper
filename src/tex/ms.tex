...
% Notice optimizing all regions gives a slightly better improvement.
% This shows that the ansatz can achieve a better fit using training waveforms with similar spins, even for waveforms with non-equal spin parameters.}
