...
% Using {\ripple} \cite{ripple} and {\jax} \cite{jax2018github}, we are able to easily recalibrate the model. 
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=\textwidth]{figures/0154_waveform_comparison.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth]{figures/q148_fl.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth]{figures/ps_q148.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth]{figures/ps_q148_quadrant.pdf}
