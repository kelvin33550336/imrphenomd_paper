...
\begin{abstract}
	...
	ignored correlations between separate parts of the waveform. We found that 
	after recalibration, despite the tail of the mismatch distribution remains 
	similar, the median mismatch between the model and NR waveforms 
	decreases by $50\%$. We further explore how different regions of the source 
...
mismatch median decreases by about $8\%$. Nevertheless, it is known that IMRPhenomD has a large 
inaccuracy in the large mass-ratio regime, and is rarely used in this region of parameter 
space. Hence, we focus on showing that AD with gradient descent, as a general and robust method, 
