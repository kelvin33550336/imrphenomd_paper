...
\begin{figure}[t]
	...
	validation. \kw{It is hard to see the blue stars on top of the orange. Play
	around with the size of the dots and change the colors. Also add the extra
	NR waveforms in table 2 with a different color but use the stars.}}}
...
\begin{table}[t]
	...
	\citep{khan2016frequency}. \kw{BE EXPLICIT ABOUT WHAT DO YOU MEAN THE REMAINING TWO!}}
	\label{tab:q148}
\end{table}
\begin{table}[t]
	\centering
