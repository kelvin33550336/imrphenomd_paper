...
\te{General points:
\begin{itemize}
	\item Overall the text needs to be refined
	\item Plot styles should be made more uniform
\end{itemize}
}
...
On the other hand, we also recalibrated coefficients with the constant spectrum for a more general purpose. 
